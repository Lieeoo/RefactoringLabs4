...
router.post('/red',authMiddleware,DeviceController.familyOfStudentEdit)// на вход {id,family_status,material_condition,educationMother,educationFather,fatherStat,motherStat } и он зарегистрирует те поля что были полными (не все из них могут быть полными)
